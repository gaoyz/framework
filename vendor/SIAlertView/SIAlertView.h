...
@property (nonatomic, assign) CGFloat contentPaddingLeft NS_AVAILABLE_IOS(5_0) UI_APPEARANCE_SELECTOR; // default is 10
@property (nonatomic, assign) NSTextAlignment messageTextAlignment NS_AVAILABLE_IOS(5_0) UI_APPEARANCE_SELECTOR; // default is 10
