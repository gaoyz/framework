...
/** The color of the slider track below the current value, defaults to nil*/
@property (nonatomic, strong) NSString *minimumTrackImgName;
/** The color of the slider track above the current value, defaults to nil */
@property (nonatomic, strong) NSString *maximumTrackImgName;
