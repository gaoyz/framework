...
@synthesize minimumTrackImgName = _minimumTrackImgName;
@synthesize maximumTrackImgName = _maximumTrackImgName;
...
- (void)setMinimumTrackImgName:(NSString *)minimumTrackImgName{
    if (minimumTrackImgName != nil) {
        UIImage *minImg = [UIImage imageNamed:minimumTrackImgName];
        if (minimumTrackImgName != nil) {
            _minimumTrackImage = [minImg stretchableImageWithLeftCapWidth:minImg.size.width/2 topCapHeight:minImg.size.height/2];
            [self customizeSlider:self.slider];
        }
    }
...
- (void)setMaximumTrackImgName:(NSString *)maximumTrackImgName{
    if (maximumTrackImgName != nil) {
        UIImage *maxImg = [UIImage imageNamed:maximumTrackImgName];
        if (maximumTrackImgName != nil) {
            _maximumTrackImage = [maxImg stretchableImageWithLeftCapWidth:maxImg.size.width/2 topCapHeight:maxImg.size.height/2];
            [self customizeSlider:self.slider];
        }
    }
